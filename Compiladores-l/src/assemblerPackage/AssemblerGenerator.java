...
public class AssemblerGenerator {
	...
	public Stack<Integer> procedureListToGoBackStack; //Se�ala a que indice de la lista de procedimientos hay que retornar 
		...
		for(Triplet t: tm.triplets)
			switch (t.getOperator()){
				...
				case "PDB":
					...
					//Almacenar el indice de la lista del procedimiento al que habr� que retornar
				...
				case "PDE":
					...
					//Se vuelve a la lista de procedimientos en la que est�bamos antes de saltar a la lista actual
